...
export class PortablePathsService {
  ...
  constructor() {
    ...
    this.appRoot = portableExecutableDir || path.dirname(app.getPath("exe"));
    this.portableMode = Boolean(portableExecutableDir) || fs.existsSync(path.join(this.appRoot, PORTABLE_MARKER_FILE));
